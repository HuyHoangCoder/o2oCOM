...
import {
  allProducts as productsData,
  dishTypes as dishTypesData,
  adsProducts,
} from "../data/data";
...
function Menu() {
  ...
  const [activeDishType, setActiveDishType] = useState("Tất cả");
  ...
  useEffect(() => {
    setDishTypes(["Tất cả", ...dishTypesData.map((d) => d.name)]);
    setAllProducts(productsData);
  }, []);

  const filteredProducts = allProducts.filter(
    (product) =>
      (activeDishType === "Tất cả" ||
        dishTypesData.find((d) => d.id === product.dish_type_id)?.name ===
          activeDishType) &&
                  ...
                  {dishTypes.map((type) => (
                    <li
                      ...
                      className={`list-group-item ${
                        activeDishType === type ? "active text-white" : ""
                      }`}
